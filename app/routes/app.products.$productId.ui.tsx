  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      if (
        ...
        Date.now() - startedAtRef.current > 5 * 60 * 1000
      ) {
        setStatus("FAILED");
        setErrorMessage(
...
export default function ProductEditorModalRoute() {
  ...
  useEffect(() => {
    if (pollStatus !== "COMPLETED" || !lastCompletedJobId || draftResult)
      return;
            ...
            <BlockStack gap="400">
              ...
              <Card>
                <BlockStack gap="300">
                  ...
                  {shopPlan === "free" && (
                    <Text as="p" variant="bodySm" tone="subdued">
                      ✦ Upgrade to Basic or higher to unlock all writing styles
                      and formats (Luxury, Technical, Playful, Hybrid).
                    </Text>
                  )}
