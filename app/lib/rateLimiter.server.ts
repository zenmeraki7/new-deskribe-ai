...
export const PLANS = ["free", "basic", "standard", "pro"] as const;
...
export function resolvePlan(subscriptionName: string | null | undefined): Plan {
  ...
  // Existing Shopify billing config still names the middle paid tier "Advanced".
  // Confirm this mapping if those subscription names change in shopify.server.ts.
